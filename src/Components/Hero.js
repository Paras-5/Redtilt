...
const Hero = () => {
  return (
    <section className="bg-[#180101] text-white py-20 text-center">
      {/* Main Hero Content */}
      <h2 className="text-4xl font-bold mb-4">From Concept to Code</h2>
      <p className="text-lg mb-8">
        We help brands and B2B enterprises build amazing websites that convert
        visitors to paying customers.
      </p>
      <button className="bg-red-600 px-6 py-3 rounded-lg text-lg hover:bg-red-700">
        Let's Have a Call
      </button>

      {/* Fancy Downward Arrow */}
      ...
      <div className="bg-red-700 mt-12 py-8">
        <h3 className="text-2xl font-semibold mb-6">Trusted by Our Partners</h3>
